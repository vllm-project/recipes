...
- If you encounter corrupted output when using vLLM to serve the M2 model, you can upgrade to the nightly version (ensure it is a version after commit `cf3eacfe58fa9e745c2854782ada884a9f992cf7`)
