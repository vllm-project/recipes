...
```bash
docker pull vllm/vllm-openai:v0.19.1       # For CUDA 12.9
docker pull vllm/vllm-openai:v0.19.1-cu130 # For CUDA 13.0
docker pull vllm/vllm-openai-rocm:v0.19.1  # For AMD GPUs
